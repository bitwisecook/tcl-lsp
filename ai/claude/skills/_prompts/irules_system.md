...
Errors: E001 (Missing subcommand — e.g. bare `string` without a subcommand), E002 (Too few arguments for command), E003 (Too many arguments for command), E200 (Unterminated command — the parser could not tell where it ends (missing `]` / `"` / `}`))
