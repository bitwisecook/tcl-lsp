...
Complete list of optimisation codes emitted by the tcl-lsp optimiser (iRule context).
...
| O105 | Constant var-ref propagation / CSE | Propagate constants into $var references and eliminate duplicate expressions |
