...
# ---------------------------------------------------------------------------
#
# Everything listed in ``__all__`` is part of the stable interface
# downstream consumers can rely on (parser, projection, tests,
# editor integrations).  Anything not listed is implementation
