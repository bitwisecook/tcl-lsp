...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="max-icmp-rate", value_type="unknown"),
            ...
            BigipPropertySpec(name="port-find-threshold-timeout", value_type="unknown"),
            BigipPropertySpec(name="port-find-threshold-trigger", value_type="unknown"),
            BigipPropertySpec(
