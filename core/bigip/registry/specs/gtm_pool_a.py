...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="fallback-ip", value_type="string", shape_kind="ip-address"),
            BigipPropertySpec(
                name="fallback-mode",
                value_type="enum",
                allow_none=True,
            ...
            BigipPropertySpec(name="limit-max-bps", value_type="integer", default="0 (zero)"),
            BigipPropertySpec(
            ...
            BigipPropertySpec(name="limit-max-pps", value_type="integer", default="0 (zero)"),
            BigipPropertySpec(
