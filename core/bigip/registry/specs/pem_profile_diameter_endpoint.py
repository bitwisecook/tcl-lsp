...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="gy-session-id-prefix", value_type="string"),
            BigipPropertySpec(name="msg-max-retransmits", value_type="integer"),
            BigipPropertySpec(name="msg-retransmit-delay", value_type="integer"),
            ...
            BigipPropertySpec(name="sd-session-id-prefix", value_type="string"),
            BigipPropertySpec(
                name="supported-apps",
                value_type="enum",
