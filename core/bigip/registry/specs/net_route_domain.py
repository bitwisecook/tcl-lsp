...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="flow-eviction-policy", value_type="reference", allow_none=True),
            ...
            BigipPropertySpec(name="parent", value_type="reference", allow_none=True),
            BigipPropertySpec(name="port-misuse", value_type="unknown"),
            BigipPropertySpec(name="routing-protocol", value_type="unknown"),
            BigipPropertySpec(
            ...
            BigipPropertySpec(name="vlans", value_type="unknown"),
        ),
    )
