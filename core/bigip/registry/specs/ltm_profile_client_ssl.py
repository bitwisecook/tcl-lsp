...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="c3d-ocsp", value_type="reference", allow_none=True),
            BigipPropertySpec(name="ca-file", value_type="reference", default="none"),
            ...
            BigipPropertySpec(name="cert-lifespan", value_type="integer", default="30"),
            BigipPropertySpec(
            ...
            BigipPropertySpec(
                ...
                default="DEFAULT, which uses the default ciphers",
            ),
            BigipPropertySpec(
                name="client-cert-ca",
                value_type="reference",
            ...
            BigipPropertySpec(name="crl-file", value_type="reference", default="none"),
            BigipPropertySpec(
                name="data-0rtt",
                value_type="enum",
                enum_values=("disabled", "enabled-no-anti-replay", "enabled-with-anti-replay"),
                default="disabled, which means TLSv1",
            ),
            BigipPropertySpec(
                name="defaults-from",
                value_type="reference",
            ...
            BigipPropertySpec(name="destination-ip-blacklist", value_type="reference"),
            BigipPropertySpec(name="destination-ip-whitelist", value_type="reference"),
            BigipPropertySpec(
            ...
            BigipPropertySpec(name="hostname-blacklist", value_type="reference"),
            BigipPropertySpec(name="hostname-whitelist", value_type="reference"),
            BigipPropertySpec(
                name="key",
                value_type="reference",
                allow_none=True,
            ...
            BigipPropertySpec(name="maximum-record-size", value_type="integer", default="16384"),
            BigipPropertySpec(
            ...
            BigipPropertySpec(
                ...
                block=(
                    ...
                    BigipPropertySpec(
                        name="no-tls", value_type="unknown", in_sections=("options",)
                    ),
            ...
            BigipPropertySpec(name="no-tls", value_type="unknown", in_sections=("options",)),
            BigipPropertySpec(name="none", value_type="unknown", in_sections=("options",)),
            BigipPropertySpec(
                name="single-dh-use",
                value_type="unknown",
            ...
            BigipPropertySpec(name="renegotiate-size", value_type="integer", default="indefinite"),
            BigipPropertySpec(
                name="renegotiation",
                value_type="enum",
                enum_values=("disabled", "enabled"),
            ...
            BigipPropertySpec(
                ...
                value_type="integer",
                default="0 which means cache timeout is used",
            ),
            BigipPropertySpec(
                name="sni-default",
                value_type="enum",
            ...
            BigipPropertySpec(name="source-ip-blacklist", value_type="reference"),
            BigipPropertySpec(name="source-ip-whitelist", value_type="reference"),
            BigipPropertySpec(
                name="ssl-c3d",
                value_type="enum",
                enum_values=("disabled", "enabled"),
