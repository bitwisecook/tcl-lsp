...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="form-action", value_type="unknown", allow_none=True),
            BigipPropertySpec(name="form-field", value_type="string"),
            ...
            BigipPropertySpec(name="start-uri", value_type="unknown", allow_none=True),
            BigipPropertySpec(
            ...
            BigipPropertySpec(name="success-match-value", value_type="string"),
