...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="auth-max-logon-attempt", value_type="integer"),
            BigipPropertySpec(
            ...
            BigipPropertySpec(name="hints", value_type="enum", enum_values=("false", "true")),
            ...
            BigipPropertySpec(name="upn", value_type="enum", enum_values=("false", "true")),
        ),
    )
