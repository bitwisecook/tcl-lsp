...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="bind-pw", value_type="string", allow_none=True),
            ...
            BigipPropertySpec(name="search-timeout", value_type="unknown"),
            ...
            BigipPropertySpec(name="version", value_type="unknown"),
            BigipPropertySpec(
                name="warnings",
                value_type="enum",
                enum_values=("disabled", "enabled"),
