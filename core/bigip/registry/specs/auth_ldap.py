...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="group-dn", value_type="unknown", allow_none=True),
            BigipPropertySpec(name="group-member-attr", value_type="unknown", allow_none=True),
            ...
            BigipPropertySpec(name="user-template", value_type="string", allow_none=True),
