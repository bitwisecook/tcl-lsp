...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="admin-dn", value_type="string", allow_none=True),
            BigipPropertySpec(
            ...
            BigipPropertySpec(name="is-ldaps", value_type="enum", enum_values=("false", "true")),
            BigipPropertySpec(
            ...
            BigipPropertySpec(name="port", value_type="unknown", allow_none=True),
            BigipPropertySpec(name="schema-attr", value_type="unknown"),
            BigipPropertySpec(
                name="group-member",
                value_type="string",
