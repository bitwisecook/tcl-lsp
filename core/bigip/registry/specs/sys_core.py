...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="bigd-manage", value_type="enum", enum_values=("false", "true")),
            ...
            BigipPropertySpec(name="mcpd-manage", value_type="enum", enum_values=("false", "true")),
            ...
            BigipPropertySpec(name="tmm-manage", value_type="enum", enum_values=("false", "true")),
