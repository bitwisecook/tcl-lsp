...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="subdomain-prefix", value_type="string", in_sections=("hosts",)),
            BigipPropertySpec(name="ibr-adaptive-lifetime", value_type="unknown"),
            BigipPropertySpec(name="ibr-default-lifetime", value_type="unknown"),
            BigipPropertySpec(name="ibr-prefix", value_type="string"),
            BigipPropertySpec(
                name="info-header",
                value_type="enum",
                allow_none=True,
            ...
            BigipPropertySpec(name="perf-monitor-data-retention-period", value_type="unknown"),
