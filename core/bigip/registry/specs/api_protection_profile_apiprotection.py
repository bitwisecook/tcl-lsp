...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            BigipPropertySpec(name="access-profile", value_type="unknown"),
            ...
            BigipPropertySpec(name="dns-mode", value_type="string"),
            ...
            BigipPropertySpec(name="max-concurrent-subsessions", value_type="integer"),
            ...
            BigipPropertySpec(name="use-pool", value_type="enum", enum_values=("false", "true")),
        ),
    )
