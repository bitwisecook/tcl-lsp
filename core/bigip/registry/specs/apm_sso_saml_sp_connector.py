...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="is-default", value_type="enum", enum_values=("false", "true")),
            BigipPropertySpec(
            ...
            BigipPropertySpec(name="multi-domain-location", value_type="string", allow_none=True),
            ...
            BigipPropertySpec(name="sp-name-qualifier", value_type="string", allow_none=True),
