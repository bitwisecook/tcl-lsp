...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="handshake-timeout", value_type="unknown"),
            BigipPropertySpec(
                name="host-ip-rewrite",
                value_type="enum",
                enum_values=("disabled", "enabled"),
            ),
            BigipPropertySpec(name="max-retransmit-attempts", value_type="unknown"),
            BigipPropertySpec(name="max-watchdog-failure", value_type="unknown"),
            ...
            BigipPropertySpec(name="retransmit-timeout", value_type="unknown"),
            BigipPropertySpec(name="watchdog-timeout", value_type="unknown"),
        ),
    )
