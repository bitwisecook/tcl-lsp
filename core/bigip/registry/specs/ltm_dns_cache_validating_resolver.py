...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="dlv-anchors", value_type="list"),
            BigipPropertySpec(
                name="forward-zones",
                value_type="list",
                allow_none=True,
            ...
            BigipPropertySpec(name="ignore-cd", value_type="enum", enum_values=("no", "yes")),
            ...
            BigipPropertySpec(name="prefetch-key", value_type="enum", enum_values=("no", "yes")),
            BigipPropertySpec(
            ...
            BigipPropertySpec(name="trust-anchors", value_type="list"),
