...
"""SMTPS::activation_mode -- Set the activation mode."""
...
_SOURCE = "https://clouddocs.f5.com/api/irules/SMTPS__activation_mode.html"
...
@register
class SmtpsActivationModeCommand(CommandDef):
                ...
                FormSpec(
                    ...
                    arg_values={
                        0: (
                            _av(
                                "none",
                                "SMTPS::activation_mode none",
                                "SMTPS::activation_mode (none | allow | require)?",
                            ),
                            _av(
                                "allow",
                                "SMTPS::activation_mode allow",
                                "SMTPS::activation_mode (none | allow | require)?",
                            ),
                            _av(
                                "require",
