...
"""DHCPv4::siaddr -- This command returns siaddr(server IP) field from DHCPv4 message."""
...
_SOURCE = "https://clouddocs.f5.com/api/irules/DHCPv4__siaddr.html"


@register
class Dhcpv4SiaddrCommand(CommandDef):
    name = "DHCPv4::siaddr"
