...
class HttpRespondCommand(CommandDef):
    ...
    def spec(cls) -> CommandSpec:
        return CommandSpec(
            ...
            event_requires=EventRequires(transport="tcp", profiles=frozenset({"HTTP", "FASTHTTP"}), also_in=frozenset({"AUTH_ERROR", "AUTH_FAILURE", "AUTH_RESULT", "AUTH_SUCCESS", "AUTH_WANTCREDENTIAL", "LB_FAILED", "MR_EGRESS", "MR_FAILED", "NAME_RESOLVED"})),
