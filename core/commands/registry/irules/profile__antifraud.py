...
"""PROFILE::antifraud -- Returns the value of a ANTIFRAUD profile setting."""
...
_SOURCE = "https://clouddocs.f5.com/api/irules/PROFILE__antifraud.html"


@register
class ProfileAntifraudCommand(CommandDef):
