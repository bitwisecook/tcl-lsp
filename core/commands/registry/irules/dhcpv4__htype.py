...
"""DHCPv4::htype -- This command returns htype (hardware type) field from DHCPv4 message."""
...
_SOURCE = "https://clouddocs.f5.com/api/irules/DHCPv4__htype.html"


@register
class Dhcpv4HtypeCommand(CommandDef):
    name = "DHCPv4::htype"
