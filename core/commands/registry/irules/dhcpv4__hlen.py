...
"""DHCPv4::hlen -- This command returns hlen (hardware len) field from DHCPv4 message."""
...
_SOURCE = "https://clouddocs.f5.com/api/irules/DHCPv4__hlen.html"


@register
class Dhcpv4HlenCommand(CommandDef):
    name = "DHCPv4::hlen"
