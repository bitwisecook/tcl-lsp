...
def cadence_command_specs() -> tuple[CommandSpec, ...]:
    ...
    return (
        ...
        _cad("syn_map", "Map the design to target technology.", "syn_map ?-effort effort?"),
        _cad(
            "syn_opt", "Perform post-map optimization.", "syn_opt ?-effort effort? ?-incremental?"
        ),
        _cad(
            "write_hdl", "Write synthesized HDL netlist.", "write_hdl ?-lec? ?design_name? > file"
        ),
        _cad("write_sdc", "Write SDC constraints.", "write_sdc > file"),
        _cad(
            "write_design", "Write a design database.", "write_design ?-innovus? ?-base_name name?"
        ),
        _cad(
            "write_do_lec",
        ...
        _cad("route_design", "Route the design.", "route_design ?-global_detail?"),
        _cad(
            "opt_design",
        ...
        _cad(
            "add_endcap", "Add endcap cells.", "add_endcap ?-pre_endcap cell? ?-post_endcap cell?"
        ),
        _cad("add_filler", "Add filler cells.", "add_filler ?-cell cell_list? ?-prefix prefix?"),
        _cad(
            "add_well_tap",
            "Add well-tap cells.",
        ...
        _cad("update_timing", "Update incremental timing.", "update_timing ?-full?"),
        _cad(
            "report_constraint",
