...
class _AnalyserCommandsMixin(_Base):
    ...
    if TYPE_CHECKING:
        ...
        def _handle_proc_command(self, *a: Any, **kw: Any) -> None: ...
        def _handle_oo_class_command(self, *a: Any, **kw: Any) -> None: ...
        def _handle_oo_define_command(self, *a: Any, **kw: Any) -> None: ...
        ...
        def _handle_namespace_eval_command(self, *a: Any, **kw: Any) -> None: ...
        def _handle_foreach_command(self, *a: Any, **kw: Any) -> None: ...
        def _handle_for_command(self, *a: Any, **kw: Any) -> None: ...
        def _handle_switch_command(self, *a: Any, **kw: Any) -> None: ...
        def _handle_catch_command(self, *a: Any, **kw: Any) -> None: ...
        def _handle_try_command(self, *a: Any, **kw: Any) -> None: ...
