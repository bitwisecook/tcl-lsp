...
- [`dsl.md`](dsl.md) — the full DSL grammar reference (EBNF,
  ...
  `f5 query --help-dsl`.
- [`builtins.md`](builtins.md) — auto-generated alphabetical
  catalogue of every builtin function with signature, examples,
  return type, and category.  Sourced by `f5 query --help-builtins`.
  Regenerated by `python3 scripts/dev/gen_query_builtins_doc.py`.
