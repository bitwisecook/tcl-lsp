...
| **S4** | Inlining of small leaf procs | [s4](wasm-aot-staircase-s4.md) | partial — S4.1 catalogue landed (e7480b4c); S4.2/S4.3 deferred (need IRCall return-value plumbing) |
