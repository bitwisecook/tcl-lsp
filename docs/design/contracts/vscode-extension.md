...
- [LSP diagnostics publication model](../../../docs/design/contracts/lsp-diagnostics-publication.md)
- [pipeline LSP-first note](../../../docs/design/contracts/pipeline-lsp-first.md)
