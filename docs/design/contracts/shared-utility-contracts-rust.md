...
| runtime command-table identity | `rust/tcl-core-types/src/lib.rs` | `CommandSlot`; `CommandId`; `NsId` | invariant; written-name parsing remains selected at ingress by the document/runtime dialect | none |
