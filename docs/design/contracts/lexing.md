...
- `rust/tcl-lexer/` — Rust port target (see [kcs-rust-migration.md](kcs-rust-migration.md)); from chunk L3 onward Rust and Python implementations must stay token-stream-equivalent via the differential test harness.
