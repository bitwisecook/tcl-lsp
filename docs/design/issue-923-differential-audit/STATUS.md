...
#### Priority tier 1 — critical + high (24 findings, 5 already fixed)
...
4. Pick the next finding to fix — two ready queues, both fully triaged:
   ...
   - §6b: 80 remaining main-wave findings (idx 61, idx 9, idx 10, idx 18,
     and idx 29 are fixed so far), fully triaged into a priority-ordered
     critical/high table (19 remaining, start here) and a
