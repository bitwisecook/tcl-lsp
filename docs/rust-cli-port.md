...
| `callgraph`/`dataflow`/`diagram` | ⛔ stub | need the serialise JSON shapes + `interproc`/`taint`/IR-module wiring (`analyser/semantic_graph.py`, `tooling/diagram/extract.py`); analyser-gapped |
