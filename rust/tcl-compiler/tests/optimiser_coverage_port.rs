...
//! exercised as O110-driven `[expr {...}]` rewrites, the form `optimiser_port.rs`
//! already uses.
//!
//! ## C-Tcl proof
//!
...
fn o119_multi_set_packing() {
    // OMISSION (as in optimiser_port.rs): with an `eval {$a $b $c}` barrier the
