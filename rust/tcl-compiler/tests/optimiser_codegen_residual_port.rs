...
//! codegen suites
//! (`optimiser_port.rs`, `optimiser_coverage_port.rs`, `optimiser_depth_port.rs`,
//! `codegen_port.rs`, `codegen_depth_port.rs`, `compiler_residual_port.rs`)
...
//!     discriminators `codegen_depth_port.rs` skips: every `string is CLASS`
