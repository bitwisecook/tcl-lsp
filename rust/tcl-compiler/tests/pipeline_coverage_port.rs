...
//!     `intervals_port.rs` leaves cold: the `classify` *negative*-index reason
...
// sees (matching `intervals_port.rs` / `analyser_port.rs`).
// ===========================================================================
...
//
// `intervals_port.rs` exercises only the `past_end` / `past_append` reasons;
...
//
// `intervals_port.rs` covers the flat `&&`/`||`/`?:` guard outcomes; these add
