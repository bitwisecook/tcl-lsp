...
//! the single-object pull/push request shaping (`object_io`), Python-`json`-
//! compatible JSON rendering (`json_compat`), and the SSH/scp transport (`ssh`)
//! shared by the `fetch` / `push` / `pull` verbs.
