...
//! the single-object pull/push request shaping (`object_io`), ASCII-safe
//! pretty-printed JSON rendering (`json_compat`), and the SSH/scp transport
//! (`ssh`) shared by the `fetch` / `push` / `pull` verbs.
