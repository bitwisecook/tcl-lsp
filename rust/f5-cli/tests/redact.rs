...
//! Differential tests for the `f5 redact` / `f5 unredact` verbs — secret
...
//!
//! `--shuffle` is deterministic here: `tcl-bigip::redact` reproduces the
...
#[test]
fn shuffle_mode_is_deterministic() {
...
#[test]
fn redact_format_tmsh_transaction() {
