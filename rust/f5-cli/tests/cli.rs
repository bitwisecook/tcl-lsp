...
//! Differential tests for the native `f5-query` CLI.
//!
...
#[test]
fn extract_plain_ucs_include_extras() {
    let ucs = fixtures_dir().join("sample.ucs");
    assert_extract_matches(
