...
def order_profiles(profiles: Sequence[str], types: Any = ...) -> list[str]: ...
def bigip_release_lifecycle(version: str | None = ...) -> str: ...
def list_secrets(text: str) -> str: ...
def config_diagnostics(text: str) -> str: ...
def report_diagnostics(
    uri: str, text: str, sources: Sequence[tuple[str, str]]
) -> str: ...
def iapp_diagnostic_evidence(uri: str, sources: Sequence[tuple[str, str]]) -> str: ...
