...
pub use ranges::{
    braced_var_name_end, close_quote_offset, command_substitution_end, word_append_offset,
    word_closer_offset, word_closer_offset_at, word_end_position, word_span, word_span_at,
};
