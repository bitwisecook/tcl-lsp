...
/// Write generated bytes only when their content differs from the file on
/// disk. Preserving the mtime for an identical output keeps Cargo build-script
/// dependencies fresh across consecutive generators.
///
