...
pub fn spec() -> CommandSpec {
    CommandSpec {
        ...
        // oversight: `split` is absent from every dialect profile's
        ...
        // no string/list-manipulation command), and none of the irules/,
        // expect/, tk/, itcl/, iapps/, or eda_*/ command packs declares an
        // override or an extra form for it, so it resolves identically
        // everywhere — the common iRules idiom `split [HTTP::uri] "/"`
