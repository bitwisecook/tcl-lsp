...
const OP_KEYWORD_VALUES: &[ArgValue] = &[
    ...
    ArgValue {
        value: "by",
        detail: "Keyword introducing the step value: `lseq count by step`. Optional even when a step follows.",
        ..ArgValue::DEFAULT
    },
];
