...
hover: Some(HoverSnippet {
    ...
    synopsis: &["smtp::sendmessage token ?-servers list? ?-ports list? ?-username user? ?-password pass? ?-usetls bool? ?-tlspolicy cmd? ?-originator addr? ?-recipients list? ?-header {key value} ...?"],
    snippet: "",
