...
const HTML_CMDS: &[Row] = &[
    ...
    (
        ...
        "This procedure is similar to the built-in Tcl for control structure.",
    ),
    (
        "html::getFormInfo",
        Arity::at_least(1),
    ...
    (
        ...
        Arity::exact(1),
        &["html::set var val"],
        "This procedure is similar to the built-in Tcl set command.",
    ),
    (
        "html::textInput",
        Arity::at_least(1),
    ...
    (
        ...
        "This procedure is similar to the built-in Tcl while control structure.",
    ),
    (
        "html::doctype",
        Arity::exact(1),
