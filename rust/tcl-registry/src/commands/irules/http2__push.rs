...
hover: Some(HoverSnippet {
            ...
            synopsis: &["HTTP2::push <uri> ?-priority num? ?-nohost? <request headers>", "HTTP2::push <uri> ?-priority num? ?-content data | -ifile file? ?-noserver? ?-nohost? <request headers> -- <response headers>"],
