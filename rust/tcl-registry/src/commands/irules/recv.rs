...
hover: Some(HoverSnippet {
        ...
        forms: &[
            FormSpec { kind: FormKind::Default, synopsis: "recv ?options? ?numChars? connection ?varname?" },
        ],
        options: &[
            OptionSpec { name: "-eol", takes_value: false, value_hint: "", detail: "Suspend until end-of-line received.", dialects: None },
            OptionSpec { name: "-peek", takes_value: false, value_hint: "", detail: "Return data but leave it buffered.", dialects: None },
