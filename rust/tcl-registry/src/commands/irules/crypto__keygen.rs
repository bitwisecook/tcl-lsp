...
hover: Some(HoverSnippet {
        ...
        forms: &[
            FormSpec { kind: FormKind::Default, synopsis: "CRYPTO::keygen (('-alg' ('random' | 'pbkdf2-md5' | 'rsa'))" },
        ],
        options: &[
            OptionSpec { name: "-alg", takes_value: true, value_hint: "ALG", detail: "Key generation algorithm.", dialects: None },
            OptionSpec { name: "-len", takes_value: true, value_hint: "LENGTH", detail: "Key length (must be multiple of 8).", dialects: None },
            OptionSpec { name: "-exp", takes_value: true, value_hint: "EXPONENT", detail: "Exponent (for RSA).", dialects: None },
            OptionSpec { name: "-passphrase", takes_value: true, value_hint: "PASSPHRASE", detail: "Passphrase for key derivation.", dialects: None },
            OptionSpec { name: "-salt", takes_value: true, value_hint: "SALT", detail: "Binary salt.", dialects: None },
