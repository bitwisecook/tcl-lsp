...
hover: Some(HoverSnippet {
            ...
            synopsis: &["DATAGRAM::tcp (flags | payload_length | window)", "DATAGRAM::tcp (option | option_count) (IPV4_OPTION)?", "DATAGRAM::tcp payload (LENGTH)?"],
        ...
        forms: &[
            FormSpec { kind: FormKind::Default, synopsis: "DATAGRAM::tcp (flags | payload_length | window)" },
        ],
        ..CommandSpec::DEFAULT
    }
}
