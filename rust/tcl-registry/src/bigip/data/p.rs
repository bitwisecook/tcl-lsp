    ...
    BigipObjectSpec {
        ...
        properties: &[
            ...
            BigipPropertySpec {
                name: "publisher",
                value_type: ValueKind::Reference,
                references: &["security_blacklist_publisher_all_blacklist_publisher", "security_blacklist_publisher_blacklist_publisher_stats", "security_blacklist_publisher_by_addr", "security_blacklist_publisher_by_category", "security_blacklist_publisher_category", "security_blacklist_publisher_profile", "sys_icall_publisher", "sys_log_config_publisher"],
                ..BigipPropertySpec::DEFAULT
            },
            BigipPropertySpec {
            ...
            BigipPropertySpec {
                ...
                block: &[
                    ...
                    BigipPropertySpec {
                        ...
                        value_type: ValueKind::Integer,
                        in_sections: &["rules"],
                        default: Some("pass-through, indicating the DSCP code of the downlink packet will not be changed when the traffic flow matches the rule"),
                        ..BigipPropertySpec::DEFAULT
                    },
                    BigipPropertySpec {
                        ...
                        value_type: ValueKind::Integer,
                        in_sections: &["rules"],
                        default: Some("pass-through, indicating the DSCP code of the uplink packet will not be changed when the traffic flow matches the rule"),
                        ..BigipPropertySpec::DEFAULT
                    },
                    BigipPropertySpec {
                        name: "dtos-tethering",
                    ...
                    BigipPropertySpec {
                        ...
                        value_type: ValueKind::Integer,
                        in_sections: &["rules"],
                        default: Some("pass-through, indicating the L2 QoS Marking of the packet will not be changed when the packet matches the rule"),
                        ..BigipPropertySpec::DEFAULT
                    },
                    BigipPropertySpec {
            ...
            BigipPropertySpec {
                ...
                block: &[
                    ...
                    BigipPropertySpec {
                        ...
                        value_type: ValueKind::Reference,
                        in_sections: &["rules", "classification-filters"],
                        references: &["analytics_application_security_anomalies_report", "analytics_application_security_anomalies_scheduled_report", "analytics_application_security_incidents_report", "analytics_application_security_network_report", "analytics_application_security_network_scheduled_report", "analytics_application_security_report", "analytics_application_security_scheduled_report", "ltm_classification_application", "ltm_classification_stats_application", "sys_application_apl_script", "sys_application_custom_stat", "sys_application_service", "sys_application_template", "sys_disk_application_volume", "wam_application"],
                        default: Some("none"),
                        ..BigipPropertySpec::DEFAULT
                    },
                    BigipPropertySpec {
            ...
            BigipPropertySpec {
                ...
                block: &[
                    ...
                    BigipPropertySpec {
                        ...
                        value_type: ValueKind::Integer,
                        in_sections: &["rules", "flow-info-filters"],
                        default: Some("disabled, indicating that the DSCP code will not be used to filter the packet in the flow-info-filter"),
                        ..BigipPropertySpec::DEFAULT
                    },
                    BigipPropertySpec {
                        name: "dst-ip-addr",
                    ...
                    BigipPropertySpec {
                        ...
                        enum_values: &["disabled", "enabled"],
                        shape_kind: Some(ValueKind::Boolean),
                        default: Some("disabled, indicating that the ECN bits will not be used to filter the packet in the flow-info-filter"),
                        ..BigipPropertySpec::DEFAULT
                    },
                    BigipPropertySpec {
                        name: "from-vlan",
                    ...
                    BigipPropertySpec {
                        ...
                        default: Some("disabled, indicating that L2 endpoint is not used for matching the flows"),
                        ..BigipPropertySpec::DEFAULT
                    },
                    BigipPropertySpec {
                        name: "operation",
            ...
            BigipPropertySpec {
                ...
                block: &[
                    ...
                    BigipPropertySpec {
                        ...
                        default: Some("string which indicates that the value-content field will be interpreted as a string"),
                        ..BigipPropertySpec::DEFAULT
                    },
                ],
                ..BigipPropertySpec::DEFAULT
            ...
            BigipPropertySpec {
                ...
                block: &[
                    ...
                    BigipPropertySpec {
                        ...
                        default: Some("session which indicates the session report will be generated if this policy applies"),
                        ..BigipPropertySpec::DEFAULT
                    },
                    BigipPropertySpec {
                        name: "interval",
    ...
    BigipObjectSpec {
        ...
        properties: &[
            ...
            BigipPropertySpec {
                name: "data-type",
                value_type: ValueKind::Integer,
                enum_values: &["enumerated", "float32", "float64", "grouped", "rat-type", "time", "unsigned32", "unsigned64"],
    ...
    BigipObjectSpec {
        ...
        properties: &[
            ...
            BigipPropertySpec {
                name: "cp",
                value_type: ValueKind::Reference,
                references: &["auth_source", "ltm_persistence_source_addr", "security_dos_auto_thresholds_top_source_ips", "security_nat_destination_translation", "security_nat_source_translation", "sys_ipfix_destination", "sys_log_config_destination_alertd", "sys_log_config_destination_arcsight", "sys_log_config_destination_ipfix", "sys_log_config_destination_local_database", "sys_log_config_destination_local_syslog", "sys_log_config_destination_management_port", "sys_log_config_destination_remote_high_speed_log", "sys_log_config_destination_remote_syslog", "sys_log_config_destination_splunk", "sys_sflow_data_source_http", "sys_sflow_data_source_interface", "sys_sflow_data_source_system", "sys_sflow_data_source_vlan"],
                ..BigipPropertySpec::DEFAULT
            },
            BigipPropertySpec {
                name: "description",
    ...
    BigipObjectSpec {
        ...
        properties: &[
            ...
            BigipPropertySpec {
                name: "data-type",
                value_type: ValueKind::Integer,
                enum_values: &["3gpp-rat-type", "3gpp-user-location-info", "ipaddr", "ipv6addr", "ipv6prefix", "octet", "time"],
                default: Some("string"),
                ..BigipPropertySpec::DEFAULT
            },
            BigipPropertySpec {
    ...
    BigipObjectSpec {
        ...
        properties: &[
            ...
            BigipPropertySpec {
                ...
                value_type: ValueKind::Enum,
                enum_values: &["called-station-id", "calling-station-id", "imeisv", "imsi", "ipaddr", "not-defined", "subs-id", "user-location-info"],
                ..BigipPropertySpec::DEFAULT
            },
        ],
    },
