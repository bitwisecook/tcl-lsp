...
fn embed_gui(manifest: &Path) {
    ...
    let has_wasm = names.iter().any(|n| n == "tcl_explorer_wasm_bg.wasm");

    let mut out = String::from("// @generated by build.rs — embedded compiler-explorer GUI bundle.\n");
