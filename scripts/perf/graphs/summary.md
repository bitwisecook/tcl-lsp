...
| 2.1.16 | 192.86 | 192.86 | 191.94 | 38.07 | 34.23 | 0 |
...
_Generated by `scripts/perf/report.py` from 4 result file(s) on Apple M1 Max (10 cores, 32 GiB, darwin-arm64) over a 113-file corpus, scope `small`, revision `1`. Wall-time axis: log10._
