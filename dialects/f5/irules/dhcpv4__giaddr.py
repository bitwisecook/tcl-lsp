...
"""DHCPv4::giaddr -- This command returns giaddr (gateway or relay IP) field from DHCPv4 message."""
...
_SOURCE = "https://clouddocs.f5.com/api/irules/DHCPv4__giaddr.html"


@register
class Dhcpv4GiaddrCommand(CommandDef):
    name = "DHCPv4::giaddr"
