...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="id", value_type="integer", required=True),
            ...
            BigipPropertySpec(name="routing-protocol", value_type="unknown", default="none"),
            BigipPropertySpec(
            ...
            BigipPropertySpec(name="vlans", value_type="unknown", default="none"),
        ),
    )
