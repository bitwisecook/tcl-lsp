        ...
        properties=(
            ...
            BigipPropertySpec(
                ...
                block=(
                    ...
                    BigipPropertySpec(
                        name="deprecated", value_type="unknown", in_sections=("rules",)
                    ),
                    BigipPropertySpec(
                        name="dscp-marking-downlink",
                        value_type="integer",
                        in_sections=("rules",),
                        default="pass-through, indicating the DSCP code of the downlink packet will not be changed when the traffic flow matches the rule",
                    ),
                    BigipPropertySpec(
                        name="dscp-marking-uplink",
                        value_type="integer",
                        in_sections=("rules",),
                        default="pass-through, indicating the DSCP code of the uplink packet will not be changed when the traffic flow matches the rule",
                    ),
                    BigipPropertySpec(
                        name="dtos-tethering",
                        value_type="unknown",
                    ...
                    BigipPropertySpec(
                        name="intercept", value_type="reference", in_sections=("rules",)
                    ),
                    BigipPropertySpec(
                        name="l2-marking-downlink",
                        value_type="integer",
                        in_sections=("rules",),
                        default="pass-through, indicating the L2 QoS Marking of the packet will not be changed when the packet matches the rule",
                    ),
                    BigipPropertySpec(
                    ...
                    BigipPropertySpec(
                        name="precedence", value_type="integer", in_sections=("rules",)
                    ),
                    BigipPropertySpec(
                        name="qoe-reporting",
                        value_type="unknown",
                    ...
                    BigipPropertySpec(
                        name="tcl-filter", value_type="unknown", in_sections=("rules",)
                    ),
                    BigipPropertySpec(
            ...
            BigipPropertySpec(
                ...
                block=(
                    ...
                    BigipPropertySpec(
                        ...
                        value_type="integer",
                        in_sections=("rules", "flow-info-filters"),
                        default="disabled, indicating that the DSCP code will not be used to filter the packet in the flow-info-filter",
                    ),
                    BigipPropertySpec(
                        name="dst-ip-addr",
                        value_type="string",
                    ...
                    BigipPropertySpec(
                        ...
                        enum_values=("disabled", "enabled"),
                        shape_kind="boolean",
                        default="disabled, indicating that the ECN bits will not be used to filter the packet in the flow-info-filter",
                    ),
                    BigipPropertySpec(
                        name="from-vlan",
                        value_type="reference",
                    ...
                    BigipPropertySpec(
                        ...
                        default="disabled, indicating that L2 endpoint is not used for matching the flows",
                    ),
                    BigipPropertySpec(
                        name="operation",
                        value_type="enum",
            ...
            BigipPropertySpec(
                ...
                block=(
                    ...
                    BigipPropertySpec(
                        ...
                        default="string which indicates that the value-content field will be interpreted as a string",
                    ),
                ),
            ),
            BigipPropertySpec(
            ...
            BigipPropertySpec(
                ...
                block=(
                    ...
                    BigipPropertySpec(
                        ...
                        default="session which indicates the session report will be generated if this policy applies",
                    ),
                    BigipPropertySpec(
                        name="interval",
                        value_type="integer",
                        in_sections=("rules", "reporting"),
                        default="0 which indicates this feature is disabled",
                    ),
                    BigipPropertySpec(
                        name="transaction",
                        value_type="unknown",
