...
def register_spec() -> BigipObjectSpec:
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(name="address", value_type="string", in_sections=("aggregator",)),
            ...
            BigipPropertySpec(name="address", value_type="string", in_sections=("ipv4",)),
            ...
            BigipPropertySpec(name="address", value_type="string", in_sections=("ipv6",)),
            ...
            BigipPropertySpec(name="address", value_type="string", in_sections=("next-hop",)),
