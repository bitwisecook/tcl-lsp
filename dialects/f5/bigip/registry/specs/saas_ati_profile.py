    ...
    return BigipObjectSpec(
        ...
        properties=(
            ...
            BigipPropertySpec(
                ...
                value_type="string",
                default="/_|_imp_apg_|_/api/dip/v1/dip",
            ),
            BigipPropertySpec(
            ...
            BigipPropertySpec(name="bas-hostname", value_type="string", default="us"),
            ...
            BigipPropertySpec(name="proxy-destination", value_type="string", default="https://us"),
            BigipPropertySpec(
                name="proxy-password",
                value_type="string",
                allow_none=True,
