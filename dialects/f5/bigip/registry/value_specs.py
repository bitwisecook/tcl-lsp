...
table in :mod:`dialects.f5.bigip.registry.pilot` ships the property-level
...
class SourceRange:
    ...
    :class:`dialects.f5.query.values.FieldSlot` but lives in the
...
class DestinationSpec(_BaseSpec):
    ...
    Mirrors the broad :class:`dialects.f5.bigip.types.Destination` class but
...
class MonitorExpressionSpec(_BaseSpec):
    ...
    Wraps the :class:`dialects.f5.bigip.types.MonitorExpression` typed value
...
def _references_from_legacy_policy_action(value: object) -> tuple[tuple[str, str], ...]:
    ...
    The legacy class lives in :mod:`dialects.f5.bigip.model._ltm` and
