...
:mod:`dialects.f5.bigip.link_extract`, treats every ``ltm virtual`` (and
...
:func:`dialects.f5.bigip.link_extract.extract_linked_bigip_objects` is reused
here, including the iRule-body scan via
:func:`dialects.f5.bigip.irules_refs.extract_irules_object_references`, so
...
def compute_cleanup(
    *,
    ...
    and the forward reference graph from :mod:`dialects.f5.bigip.link_extract`
