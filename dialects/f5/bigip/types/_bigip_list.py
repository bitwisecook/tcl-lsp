...
The matching :class:`dialects.f5.bigip.registry.value_specs.ListSpec` owns
...
- *monitor-expression* — handled by
  :class:`dialects.f5.bigip.types.MonitorExpression` as a dedicated typed
...
class SourceSpan:
    ...
    Mirrors :class:`dialects.f5.bigip.registry.value_specs.SourceRange` but
