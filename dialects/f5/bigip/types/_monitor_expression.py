...
The class lives in :mod:`dialects.f5.bigip.types` so it's available to every
consumer (parser, projection, query, LSP) the same way
:class:`Destination` and :class:`Network` are.  The matching
:class:`dialects.f5.bigip.registry.value_specs.MonitorExpressionSpec` wires
...
class MonitorExpression:
    ...
    def references(self) -> tuple[str, ...]:
        ...
        :class:`dialects.f5.bigip.registry.value_specs.Reference` records so
