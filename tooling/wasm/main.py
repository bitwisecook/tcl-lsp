...
def compile_tcl_to_wasm(
    ...
    *,
    ...
    """
    from compiler.stdlib_prelude import apply_stdlib_prelude_auto
...
def link_tcl_to_wasm(
    ...
    *,
    ...
    from compiler.codegen.wasm._bundle import bundle_wasm
    from compiler.codegen.wasm.extensions import runtime_path_for
    from compiler.stdlib_prelude import apply_stdlib_prelude_auto
