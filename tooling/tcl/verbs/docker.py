...
def _run_create(args: argparse.Namespace) -> int:
    ...
    from tooling.tclpkg.docker import DockerError, DockerfileSpec, write_dockerfile
    ...
    if getattr(args, "json", False):
        from tooling.tclpkg.docker import generate_dockerfile
...
def _run_recipe(args: argparse.Namespace) -> int:
    ...
    from tooling.tclpkg.docker import DockerError, tcl_install_recipe
...
def _run_info(args: argparse.Namespace) -> int:
    ...
    from tooling.tclpkg.docker import SUPPORTED_TCL_VERSIONS, available_recipes
