...
from tooling.tclpkg import ui


def _run_create(args: argparse.Namespace) -> int:
    from tooling.tclpkg.venv import VenvError, create_venv
...
def _run_delete(args: argparse.Namespace) -> int:
    from tooling.tclpkg.venv import VenvError, delete_venv
...
def _run_info(args: argparse.Namespace) -> int:
    from tooling.tclpkg.venv import VenvError, read_venv_config
...
def _run_list(args: argparse.Namespace) -> int:
    ...
    for candidate in candidates:
        ...
        if cfg.is_file():
            from tooling.tclpkg.venv import read_venv_config
