...
class TestBatch6WasmIgnoresMissingVar:
    ...
    def test_wasm_errors_on_missing_var(self, seed: int) -> None:
        ...
        """
        from tooling.fuzzing.wasm_backend import is_available, run_wasm  # noqa: PLC0415
...
class TestBatchWasmAcceptsIfElseElseif:
    ...
    def test_seed_no_longer_diverges(self, seed: int) -> None:
        ...
        message.
        """
        from tooling.fuzzing.harness import run_differential  # noqa: PLC0415
        from tooling.fuzzing.wasm_backend import is_available  # noqa: PLC0415
