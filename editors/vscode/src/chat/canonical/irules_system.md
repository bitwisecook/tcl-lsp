...
Errors: E001 (Missing dispatch word — e.g. bare `string` without a subcommand, or `$obj` with no TclOO method), E002 (Too few arguments for command), E003 (Too many arguments for command), E200 (Shimmer parse error — internal representation cannot be determined)
