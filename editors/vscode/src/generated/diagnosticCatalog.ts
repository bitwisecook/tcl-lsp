...
export const DIAGNOSTICS: DiagnosticDef[] = [
  ...
  },
  {
    code: "BIGIP6003",
    section: "bigip",
    description: "Virtual server references an iRule that is not defined in the configuration.",
    defaultEnabled: true,
  },
  {
    code: "BIGIP6004",
    section: "bigip",
    description:
      "An attached iRule uses HTTP:: or SSL:: commands without the matching virtual-server profile.",
    defaultEnabled: true,
  },
  {
    code: "BIGIP6005",
    section: "bigip",
    description: "Virtual server references a pool that is not defined in the configuration.",
    defaultEnabled: true,
  },
  {
    code: "BIGIP6006",
    section: "bigip",
    description: "Data group is defined but not referenced by any iRule in the configuration.",
    defaultEnabled: true,
  },
  {
    code: "BIGIP6007",
    section: "bigip",
    description: "iRule references an SNAT pool not found in the configuration.",
    defaultEnabled: true,
  },
  {
    code: "BIGIP6008",
    section: "bigip",
    description: "Pool has no members defined.",
    defaultEnabled: true,
  },
  {
    code: "BIGIP6009",
    section: "bigip",
    description: "Virtual server has a duplicate iRule attachment.",
    defaultEnabled: true,
  },
  {
    code: "BIGIP6010",
    section: "bigip",
    description:
      "An attached iRule uses a persistence profile that is not attached to the virtual server.",
    defaultEnabled: true,
  },
  {
    code: "BIGIP6011",
    section: "bigip",
    description: "IP-type data group contains an invalid IP address or network record.",
    defaultEnabled: true,
  },
  {
    code: "BIGIP6012",
  ...
  },
  {
    code: "BIGIP6013",
    section: "bigip",
    description: "A registry-declared BIG-IP object reference could not be resolved.",
    defaultEnabled: true,
  },
  {
    code: "BIGIP6014",
    section: "bigip",
    description: "A BIG-IP object declaration duplicates another object of the same kind and path.",
    defaultEnabled: true,
  },
  {
    code: "BIGIP6038",
    section: "bigip",
    description: "An iRule event requires a profile that is not active on its virtual server.",
    defaultEnabled: true,
  },
  {
    code: "BIGIP6039",
    section: "bigip",
    description: "A virtual server attaches incompatible profile types.",
    defaultEnabled: true,
  },
  {
    code: "IAPP7001",
    section: "bigip",
    description: "iApp implementation references a presentation field that is not defined.",
    defaultEnabled: true,
  },
  {
    code: "IAPP7002",
    section: "bigip",
    description: "iApp presentation field is never referenced by the implementation.",
    defaultEnabled: true,
  },
  {
    code: "IAPP7003",
