...
class TclLspSettings : PersistentStateComponent<TclLspSettings> {
    ...
    var diagnosticE006: Boolean = true
    ...
    var diagnosticW107: Boolean = true
    var diagnosticW108: Boolean = true
    var diagnosticW109: Boolean = true
    ...
    var diagnosticW129: Boolean = true
    ...
    var diagnosticW140: Boolean = true
    var diagnosticW141: Boolean = true
    var diagnosticW142: Boolean = true
    var diagnosticW143: Boolean = true
    var diagnosticW144: Boolean = true
    var diagnosticW145: Boolean = true
    var diagnosticW146: Boolean = true
    ...
    var diagnosticW314: Boolean = true
    var diagnosticW315: Boolean = true
    ...
    var diagnosticW305: Boolean = true
    ...
    var diagnosticBIGIP6013: Boolean = true
    var diagnosticBIGIP6014: Boolean = true
    var diagnosticBIGIP6038: Boolean = true
    var diagnosticBIGIP6039: Boolean = true
    ...
    fun toServerSettings(): Map<String, Any?> {
        ...
        val settings = mutableMapOf<String, Any?>(
            ...
            "diagnostics" to mapOf(
                ...
                "W107" to diagnosticW107,
                "W108" to diagnosticW108,
                "W109" to diagnosticW109,
                ...
                "W129" to diagnosticW129,
                "W135" to diagnosticW135,
                "W136" to diagnosticW136,
                "W137" to diagnosticW137,
                "W138" to diagnosticW138,
                "W139" to diagnosticW139,
                "W140" to diagnosticW140,
                "W141" to diagnosticW141,
                "W142" to diagnosticW142,
                "W143" to diagnosticW143,
                "W144" to diagnosticW144,
                "W145" to diagnosticW145,
                "W146" to diagnosticW146,
                ...
                "W314" to diagnosticW314,
                "W315" to diagnosticW315,
                ...
                "BIGIP6013" to diagnosticBIGIP6013,
                "BIGIP6014" to diagnosticBIGIP6014,
                "BIGIP6038" to diagnosticBIGIP6038,
                "BIGIP6039" to diagnosticBIGIP6039,
