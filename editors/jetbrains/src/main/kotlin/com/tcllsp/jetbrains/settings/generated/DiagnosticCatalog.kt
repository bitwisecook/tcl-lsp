...
// Source of truth: shared/codes_*.py (self-registering code registry).
...
object DiagnosticCatalog {
    val diagnostics: List<DiagnosticDef> = listOf(
        ...
        DiagnosticDef("S110", "shimmer", "S110: Byte array corrupted by a string operation before be...", true),
