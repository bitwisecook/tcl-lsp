...
object DiagnosticCatalog {
    val diagnostics: List<DiagnosticDef> = listOf(
        ...
        DiagnosticDef("IRULE1004", "irules", "IRULE1004: when block missing explicit priority", true),
        DiagnosticDef("IRULE1005", "irules", "IRULE1005: Data event without a matching *::collect call", true),
        DiagnosticDef("IRULE1006", "irules", "IRULE1006: *::payload without a matching *::collect call", true),
        DiagnosticDef("IRULE1007", "irules", "IRULE1007: *::collect without a matching *::release on the same...", true),
