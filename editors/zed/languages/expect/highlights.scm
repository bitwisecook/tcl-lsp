...
(command
  ...
  (#any-of? @function.builtin
    "::tcl::mathop::eq" "::tcl::mathop::in" "::tcl::mathop::max" "::tcl::mathop::min" "::tcl::mathop::ne" "::tcl::mathop::ni"
    "::tcl::process" "::tcl::unsupported::corotype" "after" "append" "array" "auto_execok"
    "auto_import" "auto_load" "auto_load_index" "auto_mkindex" "auto_mkindex_old" "auto_qualify"
    "auto_reset" "bgerror" "binary" "cd" "chan" "clock"
    "close" "concat" "const" "coroinject" "coroprobe" "debug"
    "dict" "disconnect" "divmod" "encoding" "eof" "eq"
    "error" "eval" "exec" "exit" "exp_continue" "exp_internal"
    "exp_pid" "exp_version" "expect" "expect_after" "expect_background" "expect_before"
    "expect_tty" "expect_user" "fblocked" "fconfigure" "fcopy" "file"
    "fileevent" "filename" "flush" "fork" "format" "frexp"
    "gets" "gettimes" "glob" "history" "http" "in"
    "incr" "info" "interact" "join" "lappend" "lassign"
    "ledit" "lgen" "lindex" "linsert" "list" "llength"
    "load" "log_file" "log_user" "lpop" "lrange" "lremove"
    "lrepeat" "lreplace" "lreverse" "lsearch" "lseq" "lset"
    "lsort" "lstring" "match_max" "max" "memory" "min"
    "modf" "ne" "ni" "noop" "oo::copy" "oo::object"
    "open" "overlay" "parity" "parray" "pid" "pkg::create"
    "pkg_mkIndex" "pkg_mkindex" "puts" "pwd" "re_quote" "read"
    "readFile" "regex::quote" "regex_quote" "regexp" "regexp::quote" "registry"
    "regsub" "remove_nulls" "remquo" "scan" "seek" "send"
    "send_error" "send_log" "send_tty" "send_user" "sleep" "socket"
    "spawn" "split" "strace" "string" "stty" "subst"
    "system" "tcl::mathop" "tcl::mathop::eq" "tcl::mathop::in" "tcl::mathop::max" "tcl::mathop::min"
