...
(command
  ...
  (#any-of? @function.builtin
    ...
    "fork" "format" "frexp" "ge" "gets" "gettimes"
    "glob" "gt" "history" "http" "in" "incr"
    "info" "interact" "join" "lappend" "lassign" "le"
    ...
    "lsort" "lstring" "lt" "match_max" "memory" "modf"
    "ne" "ni" "noop" "oo::copy" "oo::object" "open"
    "overlay" "parity" "parray" "pid" "pkg::create" "pkg_mkIndex"
    "pkg_mkindex" "puts" "pwd" "re_quote" "read" "readFile"
    "regex::quote" "regex_quote" "regexp" "regexp::quote" "registry" "regsub"
    "remove_nulls" "remquo" "scan" "seek" "send" "send_error"
    "send_log" "send_tty" "send_user" "sleep" "socket" "spawn"
    "split" "strace" "string" "stty" "subst" "system"
    ...
    "timerate" "timestamp" "trace" "trap" "unicode" "unknown"
    "unload" "unset" "update" "vwait" "wait" "writeFile"
    "zipfs" "zlib"))
