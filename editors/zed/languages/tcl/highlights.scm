...
(command
  ...
  (#any-of? @function.builtin
    ...
    "gettimes" "glob" "history" "http" "in" "incr"
    ...
    "lseq" "lset" "lsort" "lstring" "max" "memory"
    "min" "modf" "ne" "ni" "noop" "oo::copy"
    "oo::object" "open" "parray" "pid" "pkg::create" "pkg_mkIndex"
    "pkg_mkindex" "puts" "pwd" "re_quote" "read" "readFile"
    "regex::quote" "regex_quote" "regexp" "regexp::quote" "registry" "regsub"
    "remquo" "scan" "seek" "socket" "split" "string"
    "subst" "tcl::mathop" "tcl::mathop::eq" "tcl::mathop::in" "tcl::mathop::max" "tcl::mathop::min"
