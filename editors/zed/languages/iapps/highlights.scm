...
(command
  ...
  (#any-of? @function.builtin
    ...
    "fileevent" "filename" "flush" "format" "fpclassify" "frexp"
    "gets" "gettimes" "glob" "history" "http" "iapp::apm_config"
    "iapp::conf" "iapp::debug" "iapp::destination" "iapp::downgrade" "iapp::downgrade_template" "iapp::get_items"
    "iapp::is" "iapp::make_safe_password" "iapp::pool_members" "iapp::substa" "iapp::template" "iapp::tmos_version"
    "iapp::upgrade" "iapp::upgrade_template" "incr" "info" "join" "lappend"
    "lassign" "ledit" "lgen" "lindex" "linsert" "list"
    "llength" "load" "lpop" "lrange" "lremove" "lrepeat"
    "lreplace" "lreverse" "lsearch" "lseq" "lset" "lsort"
    "lstring" "memory" "modf" "noop" "oo::copy" "open"
