...
(command
  ...
  (#any-of? @function.builtin
    ...
    "error" "eval" "event" "exec" "exit" "fasthash"
    "fblocked" "fconfigure" "fcopy" "file" "fileevent" "filename"
    "findclass" "findstr" "flush" "format" "forward" "frexp"
    "getfield" "gets" "gettimes" "glob" "history" "html_encode"
    "html_escape" "htmlencode" "htonl" "htons" "http" "http_client_ip"
    "http_content_len_max" "http_cookie" "http_header" "http_host" "http_method" "http_uri"
    "http_version" "ifile" "imid" "in" "incr" "info"
    "ip_addr" "ip_protocol" "ip_tos" "ip_ttl" "join" "lappend"
    "lassign" "lasthop" "ledit" "lgen" "lindex" "link_qos"
    "linsert" "list" "listen" "llength" "llookup" "load"
    "local_addr" "local_port" "log" "lpop" "lrange" "lremove"
    "lrepeat" "lreplace" "lreverse" "lsearch" "lseq" "lset"
    "lsort" "lstring" "matchclass" "md4" "md5" "members"
    "memory" "modf" "ne" "nexthop" "ni" "node"
    "nodes" "noop" "ntohl" "ntohs" "oo::copy" "oo::object"
    "open" "parray" "peer" "pem_dtos" "persist" "pid"
    "pkg::create" "pkg_mkIndex" "pkg_mkindex" "pool" "priority" "puts"
    "pwd" "radius_authenticate" "rateclass" "re_quote" "read" "readFile"
