...
(command
  ...
  (#any-of? @keyword
    "break" "const" "continue" "error" "eval" "global"
    "return" "uplevel" "upvar" "variable" "when"))
...
(command
  ...
  (#any-of? @function.builtin
    ...
    "after" "append" "array" "auto_load_index" "b64decode" "b64encode"
    "binary" "call" "check" "class" "client_addr" "client_port"
    "clientside" "clock" "clone" "close" "concat" "connect"
    "cpu" "crc32" "decode_uri" "discard" "domain" "drop"
    "encoding" "event" "fasthash" "findclass" "findstr" "format"
    "forward" "getfield" "gettimes" "history" "html_encode" "html_escape"
    "htmlencode" "htonl" "htons" "http_client_ip" "http_content_len_max" "http_cookie"
    "http_header" "http_host" "http_method" "http_uri" "http_version" "ifile"
    "imid" "incr" "info" "ip_addr" "ip_protocol" "ip_tos"
    "ip_ttl" "join" "lappend" "lasthop" "lgen" "lindex"
    "link_qos" "linsert" "list" "listen" "llength" "llookup"
    "local_addr" "local_port" "log" "lrange" "lreplace" "lsearch"
    "lset" "lsort" "lstring" "matchclass" "md4" "md5"
    "members" "nexthop" "node" "nodes" "noop" "ntohl"
    "ntohs" "parray" "peer" "pem_dtos" "persist" "pkg_mkIndex"
    "pool" "priority" "puts" "radius_authenticate" "rateclass" "read"
    "recv" "redirect" "regexp" "regsub" "reject" "relate_client"
    "relate_server" "remote_addr" "remote_port" "rmd160" "scan" "send"
    "server_addr" "server_port" "serverside" "session" "sha1" "sha256"
    "sha384" "sha512" "sharedvar" "snat" "snatpool" "split"
    "string" "subst" "substr" "table" "tclLog" "tclPkgSetup"
    "tclPkgUnknown" "tcl_endOfWord" "tcl_startOfNextWord" "tcl_startOfPreviousWord" "tcl_wordBreakAfter" "tcl_wordBreakBefore"
