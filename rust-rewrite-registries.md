...
- **`irules`** — `side_effects` 1002→0, `forms` 999→0, `hover_source_url` 996→0, `hover_examples` 813→0, `hover_return_value` 496→0, `options` 54→5, `subcommands` 47→0, `arg_roles` 4→5, `lowering_hook` 0→2, `arity_bounded` 31→34, `traits` 62→69, `hover_synopsis` 999→1015
- **`iapps`** — `forms` 49→0
