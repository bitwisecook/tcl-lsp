...
<details><summary><b>tcl</b> — 229 entries · 26 ✅ · 203 need work</summary>
...
| `::tcl::mathop::eq` | `forms` |
| `::tcl::mathop::in` | `forms` |
| `::tcl::mathop::max` | `forms` |
| `::tcl::mathop::min` | `forms` |
| `::tcl::mathop::ne` | `forms` |
| `::tcl::mathop::ni` | `forms` |
| `::tcl::mathop::|` | `forms` |
| `::tcl::mathop::||` | `forms` |
...
| `nextto` | `forms` |
| `ni` | `forms` |
| `oo::abstract` | `sum≠` `syn≠` `arity≠` |
| `oo::class` | `sum≠` `syn≠` `arity≠` |
| `oo::configurable` | `sum≠` `syn≠` `arity≠` |
| `oo::copy` | `sum≠` `syn≠` `arity≠` |
| `oo::define` | `sum≠` `syn≠` `arity≠` |
| `oo::objdefine` | `sum≠` `syn≠` `arity≠` |
| `oo::object` | `sum≠` `syn≠` `arity≠` |
| `oo::singleton` | `sum≠` `syn≠` `arity≠` |
| `open` | ✅ |
| `package` | `sum≠` `syn≠` |
| `parray` | `sum≠` |
| `pid` | `sum≠` |
...
| `puts` | `sum≠` |
| `pwd` | ✅ |
| `re_quote` | `ret` `sum≠` `syn≠` |
| `read` | `sum≠` |
| `readFile` | `forms` |
| `regex::quote` | `forms` `ex` `ret` `syn≠` |
| `regex_quote` | `ret` `sum≠` `syn≠` |
| `regexp` | `ret` |
| `regexp::quote` | `forms` `ret` `syn≠` |
| `registry` | ✅ |
| `regsub` | `ret` |
| `rename` | `sum≠` |
| `return` | ✅ |
...
<details><summary><b>stdlib</b> — 225 entries · 215 ✅ · 10 need work</summary>
...
| `http::requestHeaders` | `syn≠` |
| `http::requestLine` | ✅ |
| `http::reset` | ✅ |
| `http::responseBody` | ✅ |
| `http::responseCode` | ✅ |
| `http::responseHeaderValue` | ✅ |
| `http::responseHeaders` | `syn≠` |
| `http::responseInfo` | ✅ |
| `http::responseLine` | ✅ |
| `http::size` | ✅ |
| `http::status` | ✅ |
...
<details><summary><b>tk</b> — 55 entries · 40 ✅ · 15 need work</summary>
...
<details><summary><b>expect</b> — 35 entries · 26 ✅ · 9 need work</summary>
