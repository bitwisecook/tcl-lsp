...
- **`tcl`** — `forms` 199→0, `hover` 211→125, `hover_synopsis` 196→125, `arity_bounded` 160→119, `side_effects` 84→46, `hover_return_value` 9→0, `options` 19→11, `arg_types` 19→13, `hover_examples` 1→0, `const_fold` 10→12, `required_package` 0→2, `subcommands` 13→18, `arg_roles` 30→36, `codegen_hook` 0→7, `return_type` 92→110, `lowering_hook` 0→23, `traits` 42→104
...
| `irules` | summary | 124 | `AAA::acct_result`, `AAA::acct_send`, `AAA::auth_send` |
| `irules` | synopsis | 143 | `ACCESS::ephemeral-auth`, `ACCESS::perflow`, `ACCESS::policy` |
